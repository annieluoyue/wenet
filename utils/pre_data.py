...
with open("wav.scp",'w',encoding="utf-8") as file:
    ...
    for item in os.listdir("/home/luo/asr/wenet/examples/aishell/s1/data/aishell1"):
        file.write(item.split(".")[0]+" /home/luo/asr/wenet/examples/aishell/s1/data/aishell1/"+item+"\n")
        pass
